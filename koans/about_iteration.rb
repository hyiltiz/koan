...
class AboutIteration < Neo::Koan
  ...
  def test_collect_transforms_elements_of_an_array
    ...
    # Oh wow! map is just same as collect
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    # Oh wow, find_all/select is just a basic operation on arrays
  ...
  def test_inject_will_blow_your_mind
    ...
    # injects the argument of inject() into the 1st iterable in the block
    # and iterates over the array elements
  end
